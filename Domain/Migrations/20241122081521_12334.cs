...
{
    public partial class _12334 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("37475d47-30d8-4913-ad42-a9f624e9000c"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9019), new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9020), "Admin", "Admin", "Da thật" },
                    { new Guid("a21819ef-aebc-454e-a8b3-dcea5c5da92e"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9002), new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9016), "Admin", "Admin", "Vải Cotton" },
                    { new Guid("fa3fc443-3d1b-49c7-b374-a7b9cf5b042b"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9021), new DateTime(2024, 11, 22, 15, 15, 21, 646, DateTimeKind.Local).AddTicks(9022), "Admin", "Admin", "Vải Polyester" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("438e3d78-9623-481f-ac19-892d4f410c29"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4046), new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4046), "Admin", "Admin", "Giày Da" },
                    { new Guid("6a833282-f046-4c38-8621-9cad7b6bd416"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4056), new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4056), "Admin", "Admin", "Giày Cao Gót" },
                    { new Guid("6ada2a2c-4e7c-43bf-8530-08640bb364a4"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4044), new DateTime(2024, 11, 22, 15, 15, 21, 647, DateTimeKind.Local).AddTicks(4040), "Admin", "Admin", "Giày Thể Thao" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("496a1028-aefd-4d35-a88f-8bef8c5747d9"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế nhựa" },
                    { new Guid("e1b65851-d577-415f-9d5d-331358fdb06c"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế vải" },
                    { new Guid("fb91ca2b-8386-40e1-9b45-71ce84ca5918"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế cao su" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1d334f4a-d270-440d-bc89-95720fd51d08"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5117), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5118), "Admin", "Admin", "Size 39" },
                    { new Guid("25f30636-a007-4d76-969e-7990af538eb2"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5109), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5113), "Admin", "Admin", "Size 37" },
                    { new Guid("53848d73-227e-485f-a129-37ece372c6be"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5115), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(5116), "Admin", "Admin", "Size 38" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b3f2bd25-7d4a-4a01-993d-5e175c9c19d4"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7511), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7511), "Admin", "Admin", "Cổ Điển" },
                    { new Guid("b8237be4-2aae-450a-b9ef-4442b8bab8e5"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7502), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7500), "Admin", "Admin", "Thể Thao" },
                    { new Guid("f0dd2c53-53b3-453c-804e-51ac3bf8f1cd"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7515), new DateTime(2024, 11, 22, 15, 15, 21, 650, DateTimeKind.Local).AddTicks(7515), "Admin", "Admin", "Hiện Đại" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b5dc7937-e753-4054-a778-45b94079a9f9"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5463), new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5463), "Admin", "Admin", "Green" },
                    { new Guid("bbcea382-8025-4dde-8981-30f2c0cd32fc"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5464), new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5465), "Admin", "Admin", "Blue" },
                    { new Guid("edf8b19c-6ebd-4493-bf5c-16f5106f8cd3"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5457), new DateTime(2024, 11, 22, 15, 15, 21, 651, DateTimeKind.Local).AddTicks(5460), "Admin", "Admin", "Red" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("6c4fc1e1-f45d-4c7f-9074-e00fa79378a1"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2719), new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2718), "Admin", "Admin", "Adidas" },
                    { new Guid("6ef1e23b-131d-4fc9-b5b0-33a99ad35dd0"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2720), new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2720), "Admin", "Admin", "Puma" },
                    { new Guid("fecc4952-6978-4f30-bc80-e77013c137d6"), 1, new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2716), new DateTime(2024, 11, 22, 15, 15, 21, 655, DateTimeKind.Local).AddTicks(2709), "Admin", "Admin", "Nike" }
                });
