    ...
    public partial class duan : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("84c1d648-32d7-4a61-b2a8-3c3ebeaaa664"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3659), new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3659), "Admin", "Admin", "Da thật" },
                    { new Guid("b40f83ff-61ea-4e29-82cc-4400af585be0"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3643), new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3656), "Admin", "Admin", "Vải Cotton" },
                    { new Guid("bdd48bd6-2c4a-4f56-866c-f33c66a63db1"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3661), new DateTime(2024, 12, 4, 10, 36, 15, 749, DateTimeKind.Local).AddTicks(3661), "Admin", "Admin", "Vải Polyester" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("142c6cfc-2413-4284-ba6d-7f74ed18993b"), "QL", "Quản lý" },
                    { new Guid("50494fec-5d26-442b-8df7-3305c5f5c7e3"), "KK", "Thủ kho" },
                    { new Guid("72a0edfa-a4a6-4c8c-bd0c-ebab66342a32"), "KT", "Kế toán" },
                    { new Guid("76a62e01-cc52-40c8-9bdf-ca8e17020060"), "NV", "Nhân viên" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00c13b9b-36e7-4d6a-aa65-b7476087bc84"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(760), new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(759), "Admin", "Admin", "Giày Da" },
                    { new Guid("43e95b5b-05a8-489c-aa77-ff5a6aa1fb80"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(762), new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(761), "Admin", "Admin", "Giày Cao Gót" },
                    { new Guid("d42520fa-e300-4127-b99b-e7aedc120f96"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(757), new DateTime(2024, 12, 4, 10, 36, 15, 750, DateTimeKind.Local).AddTicks(753), "Admin", "Admin", "Giày Thể Thao" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2b115c05-c2e5-42b0-a10d-3778b75a3c5f"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế cao su" },
                    { new Guid("798c1765-e881-4356-8527-9dc9b5fa5bc0"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế nhựa" },
                    { new Guid("f244420f-6196-4ae3-a5b0-8d7bf5d628aa"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế vải" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a6e21b13-905b-492a-b4f5-5fb4e8122848"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6311), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6319), "Admin", "Admin", "Size 37" },
                    { new Guid("f5380c18-a9ca-47b3-9479-d87c6bbae26e"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6328), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6329), "Admin", "Admin", "Size 38" },
                    { new Guid("fe91d76c-dd12-41aa-8b24-7c1248fed731"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6331), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(6331), "Admin", "Admin", "Size 39" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("34e46cf6-5c16-45f2-87c1-d248eb3ab9bc"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9547), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9547), "Admin", "Admin", "Cổ Điển" },
                    { new Guid("658bcf49-2c50-4e71-932a-ea0f2db0ebf9"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9550), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9549), "Admin", "Admin", "Hiện Đại" },
                    { new Guid("6e58f7ff-658a-4557-a4c5-d946358df0ff"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9545), new DateTime(2024, 12, 4, 10, 36, 15, 755, DateTimeKind.Local).AddTicks(9543), "Admin", "Admin", "Thể Thao" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("23ce3ab3-85d1-4b2c-a807-a5df1f1984c7"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5566), new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5567), "Admin", "Admin", "Blue" },
                    { new Guid("27bb3a5e-b916-450c-983c-79a631a502a4"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5564), new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5564), "Admin", "Admin", "Green" },
                    { new Guid("3e16ef78-55fe-44d8-bfb6-bd7f2272c1c7"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5552), new DateTime(2024, 12, 4, 10, 36, 15, 757, DateTimeKind.Local).AddTicks(5561), "Admin", "Admin", "Red" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3a108ff6-90de-4855-b6fa-441f0ec480bc"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1833), new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1833), "Admin", "Admin", "Puma" },
                    { new Guid("b00b3ac0-9623-4fa6-8156-2ae05bb42eb1"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1831), new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1831), "Admin", "Admin", "Adidas" },
                    { new Guid("b3485fc3-6884-4b3e-93c8-63ed26a8557f"), 1, new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1828), new DateTime(2024, 12, 4, 10, 36, 15, 763, DateTimeKind.Local).AddTicks(1818), "Admin", "Admin", "Nike" }
                });
