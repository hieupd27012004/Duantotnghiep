    ...
    public partial class duAn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("6fef2bb8-48f1-4285-a75d-dfb6ea67034a"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4237), new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4237), "Admin", "Admin", "Da thật" },
                    { new Guid("afb38795-3ea0-4e23-b5b2-459c48a8ac88"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4203), new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4232), "Admin", "Admin", "Vải Cotton" },
                    { new Guid("b5c40c97-a263-414f-afa6-fc81e37e9ef8"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4241), new DateTime(2024, 12, 14, 14, 56, 58, 162, DateTimeKind.Local).AddTicks(4242), "Admin", "Admin", "Vải Polyester" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("215c37c1-4026-48f5-8c4d-e6e856844de1"), "NV", "Nhân viên" },
                    { new Guid("86d57eea-1c8c-4384-9ee2-1174ff81f9f4"), "KK", "Thủ kho" },
                    { new Guid("b6a9e9fd-3050-4766-b73a-0fa2d4b6e206"), "QL", "Quản lý" },
                    { new Guid("fceb0a6e-0eb0-441c-82ec-bb8f6ef19b55"), "KT", "Kế toán" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3ee2d752-c016-4aed-b14f-b611496bee4f"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5310), new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5303), "Admin", "Admin", "Giày Thể Thao" },
                    { new Guid("c5160c09-22e9-4547-b94d-3fc0763d3c94"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5321), new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5320), "Admin", "Admin", "Giày Cao Gót" },
                    { new Guid("d8f031a7-bd75-40bf-b60a-bbf1ae0d9d46"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5316), new DateTime(2024, 12, 14, 14, 56, 58, 163, DateTimeKind.Local).AddTicks(5315), "Admin", "Admin", "Giày Da" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("523506db-9594-4213-b01c-bb54f8c2027c"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế nhựa" },
                    { new Guid("a0512997-b079-4062-80ca-1b2222412d2e"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế cao su" },
                    { new Guid("c2938779-cbea-433e-9a2f-b5f732e8a25c"), 1, new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin", "Admin", "Đế vải" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("8122f9b2-5b17-4116-8111-f026998d6052"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(7999), new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(8000), "Admin", "Admin", "Size 38" },
                    { new Guid("afa47268-dd46-46a4-b901-0f111716b61a"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(8006), new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(8007), "Admin", "Admin", "Size 39" },
                    { new Guid("eb61d25f-7ced-452f-a88f-3dd5f0f91c20"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(7974), new DateTime(2024, 12, 14, 14, 56, 58, 178, DateTimeKind.Local).AddTicks(7992), "Admin", "Admin", "Size 37" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a2dc6a59-e6a5-4cb3-ae44-6f9c154d8415"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(48), new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(47), "Admin", "Admin", "Cổ Điển" },
                    { new Guid("bcf3cced-ee91-4326-93f1-c72755869776"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(54), new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(53), "Admin", "Admin", "Hiện Đại" },
                    { new Guid("dbd9d4be-0373-4d94-8c2e-fd9e50bac94b"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(39), new DateTime(2024, 12, 14, 14, 56, 58, 180, DateTimeKind.Local).AddTicks(25), "Admin", "Admin", "Thể Thao" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1cff6dc9-965c-4ebf-99ef-faa68044dbe6"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1394), new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1396), "Admin", "Admin", "Green" },
                    { new Guid("41a35a6a-71d5-4fa1-8d86-75331364323b"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1339), new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1356), "Admin", "Admin", "Red" },
                    { new Guid("4bf9d43d-d7aa-4376-ae53-b722bbf73258"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1402), new DateTime(2024, 12, 14, 14, 56, 58, 185, DateTimeKind.Local).AddTicks(1403), "Admin", "Admin", "Blue" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2034518a-7a6f-4f20-a714-b1c5d4c2aed6"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5324), new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5323), "Admin", "Admin", "Adidas" },
                    { new Guid("90d7ec12-a300-485c-a7dc-ebf65af6e9e5"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5314), new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5292), "Admin", "Admin", "Nike" },
                    { new Guid("edb22525-2393-4c55-abc1-1d4114d2b60e"), 1, new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5330), new DateTime(2024, 12, 14, 14, 56, 58, 200, DateTimeKind.Local).AddTicks(5329), "Admin", "Admin", "Puma" }
                });
